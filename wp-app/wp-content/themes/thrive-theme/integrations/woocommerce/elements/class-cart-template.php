 ...
 */
class Cart_Template extends \Thrive_Theme_Cloud_Element_Abstract {
	...
	public static function shortcode() {
		return WooCommerce\Shortcodes\Cart_Template::SHORTCODE;
	}
...
return new Cart_Template( 'cart-template' );
