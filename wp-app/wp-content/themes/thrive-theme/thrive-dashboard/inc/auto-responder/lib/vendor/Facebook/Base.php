 ...
 */
abstract class Thrive_Dash_Api_Facebook_Base {
	/**
	 * Version.
	 */
	const VERSION = '3.2.3';
	 ...
	 *
	 * @return Thrive_Dash_Api_Facebook_Base
	 */
	 ...
	 * @throws Tve_Facebook_Api_Exception
	 */
	...
	protected function makeRequest( $url, $params, $ch = null ) {
		...
		/* Unset the method type */
		unset( $params['method'] );

		$json = tve_dash_api_remote_get( $url . '?' . http_build_query( $params, null, '&' ), $args );
	...
	protected function throwAPIException( $result ) {
		$e = new Tve_Facebook_Api_Exception( $result );
		switch ( $e->getType() ) {
