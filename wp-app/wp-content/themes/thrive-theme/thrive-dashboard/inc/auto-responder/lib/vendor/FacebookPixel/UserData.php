...
class UserData implements ArrayAccess {
	 ...
	 *
	 * @param string[] $phones A list of phone numbers. Include only digits with country code, area code, and number.
	 *
	 * @return $this
	 */
	 ...
	 *
	 * @param Gender $gender Gender, in lowercase. Either f or m.
	 *
	 * @return $this
	 */
	 ...
	 * <p>Example: array('f', 'm')
	 *
	 * @param Gender[] $genders A list of Genders, in lowercase.
	 *
	 * @return $this
	 */
	 ...
	 *
	 * @param string $dobd The date of birthday.
	 *
	 * @return $this
	 */
