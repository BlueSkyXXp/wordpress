...
Tags: WeChat Pay, Alipay, Stripe, WooCommerce, MemberPress, LifterLMS, Simple Membership, Payment Page, payments, custom payment amounts, one-time payments, subscriptions, WeChat, weixin, tencent, China, 
...
Accept WeChat Pay and Alipay via Stripe with WooCommerce, MemberPress, LifterLMS, Simple Membership, or Payment Page. 

== Description ==
 
Accept WeChat Pay and Alipay via Stripe with a checkout flow optimized for Chinese customers. WooCommerce, MemberPress, LifterLMS, Simple Membership, and Payment Page are supported. 
...
## 🔃 ALIPAY RECURRING SUBSCRIPTION PAYMENTS
...
* Integrations with WooCommerce, MemberPress, LifterLMS, Simple Membership and Payment Page.
* Stripe Connect for easily connecting your Stripe account w/o API keys.

## PRO FEATURES
* **Remove 2% Transaction Fee**
* **Alipay Recurring payments (only WooCommerce)**
...
To remove the fee and get access to other features, like checkout optimizations for Chinese customers and recurring Alipay payments, please [see our paid plans](https://chinapaymentsplugin.com/pricing/). 
...
1. Payment Page Template
2. Payment Page Payment Form Closeup  
3. WooCommerce Checkout
4. WooCommerce Checkout Closeup
