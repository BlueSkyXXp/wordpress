<div class="ttb-wizard-layout-holder">
	...
	<div class="ttb-placeholder p-layout mt-40 ttb-width pb-20">
		<div class="p-content">
			<div class="p-layout mb-40">
				<?php foreach ( range( 1, 2 ) as $i ) : ?>
					<div style="width: 48%">
						<?php foreach ( range( 1, 10 ) as $j ) : ?>
							<div class="p-box" style="height: 280px;"></div>
							<div class="p-box mt-25" style="height: 20px; width: 60%"></div>
							<div class="p-box mt-20" style="height: 10px"></div>
							...
							<div class="p-box mt-5" style="height: 10px"></div>
							<div class="p-box mt-5" style="height: 10px"></div>
							<div class="p-box mt-5 mb-40" style="height: 10px; width: 70%"></div>
						<?php endforeach ?>
					</div>
				<?php endforeach; ?>
			</div>
