...
$wistia_options = thrive_video_post_format( Thrive_Video_Post_Format_Main::WISTIA )->get_video_options_meta();
$url_options    = $wistia_options['url'];
$prefix         = Thrive_Video_Post_Format_Main::VIDEO_META_PREFIX . '_' . Thrive_Video_Post_Format_Main::WISTIA . '_';

?>

<div class="thrive-video-container" data-type="wistia" style="display:none">
	...
	<div class="thrive-row">
		...
		<div class="thrive-cell">
			<?php foreach ( $wistia_options as $key => $option ) : ?>
	...
	<div class="thrive-row">
		<div class="thrive-cell">
			<?php echo __( 'Video Start Time', 'thrive-theme' ); ?>
		</div>
		<div class="thrive-cell thrive-video-start">
			<label for="<?php echo $prefix . 'start_time_minutes'; ?>"> <?php echo __( 'Minutes', 'thrive-theme' ); ?></label>
			<input type="text" maxlength="2" id="<?php echo $prefix . 'start_time_minutes'; ?>" name="<?php echo $prefix . 'start_time_minutes'; ?>"
				   class="thrive-video-time-input" value="<?php echo $wistia_options['start_time_minutes']['value']; ?>" placeholder="0"/>

			<label for="<?php echo $prefix . 'start_time_seconds'; ?>"> <?php echo __( 'Seconds', 'thrive-theme' ); ?></label>
			<input type="text" maxlength="2" id="<?php echo $prefix . 'start_time_seconds'; ?>" name="<?php echo $prefix . 'start_time_seconds'; ?>"
				   class="thrive-video-time-input" value="<?php echo $wistia_options['start_time_seconds']['value']; ?>" placeholder="0"/>
		</div>
	</div>
</div>
