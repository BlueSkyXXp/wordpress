...
* Adds support for CF7 (Thanks to [@darko-a7](https://wordpress.org/support/topic/contact-forrm-7-bypass-solution/)) ([more info](https://perishablepress.com/disable-wp-rest-api/#contact-form-7))
