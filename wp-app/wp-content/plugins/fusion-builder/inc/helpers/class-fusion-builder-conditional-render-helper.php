...
class Fusion_Builder_Conditional_Render_Helper {
	...
	public static function is_match( $current_value, $desired_value, $comparison ) {
		$current_value = is_array( $current_value ) ? array_map( 'strtolower', $current_value ) : ( is_string( $current_value ) ? strtolower( $current_value ) : $current_value );
		$desired_value = is_array( $desired_value ) ? array_map( 'strtolower', $desired_value ) : ( is_string( $current_value ) ? strtolower( $desired_value ) : $desired_value );
