...
class Event implements ArrayAccess {
	...
	protected static $param_types = array(
		...
		'opt_out'                         => 'bool',
		'event_id'                        => 'string',
		'user_data'                       => 'TVD\Autoresponder\FacebookPixel\UserData',
		'custom_data'                     => 'TVD\Autoresponder\FacebookPixel\CustomData',
	...
	public function normalize() {
		...
		$normalized_payload                                    = array_filter( $normalized_payload, static function ( $val ) {
			if ( is_array( $val ) ) {
				return true;
			}
